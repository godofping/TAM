...
<div class="row heading-bg">
	...
	<div class="col-xs-12">
		<?php $qry = mysqli_query($connection, "select * from employee_view where employeeid = '" . $_SESSION['employeeid'] . "'");
		$res = mysqli_fetch_assoc($qry); ?>

		<h3>Welcome <?php echo $res['fullname']; ?></h3>
		<h4><?php echo $res['jobposition']; ?></h4>
		<br>
		<br>
