...
$_SESSION['page'] = 'employee-accounts';
include('header.php');
 ?>
<!-- Title -->
	...
	<div class="col-sm-12">
		<div class="panel panel-default card-view">
			<div class="panel-heading">
				<div class="pull-left">
					<h6 class="panel-title txt-dark">List of Employees</h6>
				</div>
				<div class="clearfix"></div>
				<div class="pull-right">
					<button type="button" class="btn btn-primary " data-toggle="modal" data-target="#AddModal">Add Employee Account</button>
				</div>
				<div class="clearfix"></div>
			</div>
					...
					<div class="table-wrap">
						<div class="table-responsive">
							<table id="datable_1" class="table table-hover display  pb-30" >
								...
								<tbody>
									<?php
									$qry = mysqli_query($connection, "select * from employee_table");
									...
									<tr>
										...
										<td class="text-nowrap">
											...
											<a href="javascript:void(0);" class="mr-25" data-toggle="modal" data-target="#EditModal<?php echo $res['employeeid']; ?>"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>

											<a href="javascript:void(0);" class="mr-25" data-toggle="modal" data-target="#DeleteModal<?php echo $res['employeeid']; ?>"> <i class="fa fa-close text-danger m-r-10"></i> </a>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="add.php" method="POST">
					...
					<div class="form-group mt-30 mb-30">
						<label class="control-label mb-10 text-left">Job Position</label>
			...
			<div class="modal-footer">
				...
				<input type="text" name="from" value="add-employee-account" hidden="">
...
<div class="modal fade" id="EditModal<?php echo $res['employeeid']; ?>" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			<div class="modal-body">
				<form action="update.php" method="POST">
					...
					<div class="form-group mt-30 mb-30">
						<label class="control-label mb-10 text-left">Job Position</label>
						<select class="form-control" name="jobposition" required="">
							<option selected="" value="<?php echo $res['jobposition']; ?>"><?php echo $res['jobposition']; ?></option>
							<option value="Cashier">Cashier</option>
							<option value="Cook">Cook</option>
						</select>
					</div>
			...
			<div class="modal-footer">
				...
				<input type="text" name="from" value="update-employee-account" hidden="">
				<button type="submit" class="btn btn-primary">Save</button>
				</form>
			</div>
		</div>
...
<div class="modal fade bs-example-modal-sm in" id="DeleteModal<?php echo $res['employeeid']; ?>" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<input type="text" name="employeeid" value="<?php echo $res['employeeid'] ?>" hidden>
				<input type="text" name="from" value="delete-employee-account" hidden="">
